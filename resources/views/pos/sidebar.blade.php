<div class="sidebar p-3">
    ...
    <nav class="nav flex-column">
        <ul class="list-unstyled">
            ...
            {{-- <li>
                <a href="{{ route('users.permissions.edit') }}"
                    class="nav-link {{ Request::routeIs('users.permissions.edit') ? 'active' : '' }}">
                    <i class="bi bi-people me-2"></i>Users
                </a>
            </li>
            <li>
                <a href="{{ route('users.permissions.update') }}"
                    class="nav-link {{ Request::routeIs('users.permissions.update') ? 'active' : '' }}">
                    <i class="bi bi-shield-lock me-2"></i>Update Permissions
                </a>
            </li> --}}
                ...
                <li>
                    ...
                    <div class="collapse ms-4 {{ $categoryActive ? 'show' : '' }}" id="categoryMenu">
                        <ul class="list-unstyled">
                            ...
                            {{-- Only show "Add" if user has permission --}}
                            @can('category.create')
                                <li>
                            ...
                            {{-- Only show "List" if user has permission --}}
                            @can('category.view')
                                <li>
            ...
            <!-- Customers -->
            @canany(['customers.view', 'customers.create'])
                <li>
                    @php
